...
from ultralytics.nn.modules.cbam_block import CBAM
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            args = [c1, *args[1:]]  # CBAM only needs input channels plus any extra args
            c2 = c1  # output channels same as input (CBAM is attention, not conv)
